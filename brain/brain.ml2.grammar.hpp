...
namespace brain {
	...
	LEAF_RULE( l_int , ((int   ,value)), int_p        [value=arg1] ) { return value_expression(value); }
	LEAF_RULE( l_dbl , ((double,value)), strict_real_p[value=arg1] ) { return value_expression(value); }
	...
	RULE_GROUP( precd0, (op_parens)(l_dbl)(l_int)(l_var) );
	...
	// Precd 2: RTOL associative (**)
	RULE( precd2, (root), precd1[root=arg1] >> !(precd2_op_tail[root=arg1]) ) { return root; }
	RULE( pow_op_tail, (lhs)(rhs), eps_p[lhs=precd2.root] >> "**" >> precd2[rhs=arg1] ) { return pow_expression( lhs, rhs ); }
	RULE_GROUP( precd2_op_tail, (pow_op_tail) );

	// Precd 3: LTOR associative (*,/)
	RULE( precd3, (root), precd2[root=arg1] >> *(precd3_op_tail[root=arg1]) ) { return root; }
	RULE( div_op_tail, (lhs)(rhs), eps_p[lhs=precd3.root] >> '/' >> precd2[rhs=arg1] ) { return div_expression( lhs, rhs ); }
	RULE( mul_op_tail, (lhs)(rhs), eps_p[lhs=precd3.root] >> '*' >> precd2[rhs=arg1] ) { return mul_expression( lhs, rhs ); }
	RULE_GROUP( precd3_op_tail, (mul_op_tail)(div_op_tail) );

	// Precd 4: LTOR associative (+,-)
	RULE( precd4, (root), precd3[root=arg1] >> *(precd4_op_tail[root=arg1]) ) { return root; }
	RULE( add_op_tail, (lhs)(rhs), eps_p[lhs=precd4.root] >> '+' >> precd3[rhs=arg1] ) { return add_expression( lhs, rhs ); }
	RULE( sub_op_tail, (lhs)(rhs), eps_p[lhs=precd4.root] >> '-' >> precd3[rhs=arg1] ) { return sub_expression( lhs, rhs ); }
	RULE_GROUP( precd4_op_tail, (add_op_tail)(sub_op_tail) );
