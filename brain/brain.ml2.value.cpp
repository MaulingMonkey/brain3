...
namespace brain {
	namespace ml2 {
		...
		template <> class functor_object_adapter_base< boost::function<void ()> >                    : public functor_object { protected: boost::function<void ()>     * f;               virtual value invoke( value** begin, value** end ) const { if ( end-begin != 0 ) throw std::runtime_error( "Expected 0 arguments." );        (*f)(); return value(); } };
		template <> class functor_object_adapter_base< boost::function<value()> >                    : public functor_object { protected: boost::function<value()>     * f;               virtual value invoke( value** begin, value** end ) const { if ( end-begin != 0 ) throw std::runtime_error( "Expected 0 arguments." ); return (*f)(); } };
		template <> class functor_object_adapter_base< boost::function<void (value)> >               : public functor_object { protected: boost::function<void (value)>* f;               virtual value invoke( value** begin, value** end ) const { if ( end-begin != 1 ) throw std::runtime_error( "Expected 1 arguments." );        (*f)(boost::cref(**begin)); return value(); } };
		template <> class functor_object_adapter_base< boost::function<value(value)> >               : public functor_object { protected: boost::function<value(value)>* f;               virtual value invoke( value** begin, value** end ) const { if ( end-begin != 1 ) throw std::runtime_error( "Expected 1 arguments." ); return (*f)(boost::cref(**begin)); } };
		template <> class functor_object_adapter_base< boost::function<void (std::vector<value*>)> > : public functor_object { protected: boost::function<void (std::vector<value*>)>* f; virtual value invoke( value** begin, value** end ) const { std::vector<value*> v(begin,end);                                                 (*f)(boost::cref(v)); return value(); } };
		template <> class functor_object_adapter_base< boost::function<value(std::vector<value*>)> > : public functor_object { protected: boost::function<value(std::vector<value*>)>* f; virtual value invoke( value** begin, value** end ) const { std::vector<value*> v(begin,end);                                          return (*f)(boost::cref(v)); } };
#endif
		...
		value::value( const boost::function<void ()>                   & f ) { init(functor_object_adapter<boost::function<void ()>                   >(f)); }
		value::value( const boost::function<value()>                   & f ) { init(functor_object_adapter<boost::function<value()>                   >(f)); }
		value::value( const boost::function<void (value)>              & f ) { init(functor_object_adapter<boost::function<void (value)>              >(f)); }
		value::value( const boost::function<value(value)>              & f ) { init(functor_object_adapter<boost::function<value(value)>              >(f)); }
		value::value( const boost::function<void (std::vector<value*>)>& f ) { init(functor_object_adapter<boost::function<void (std::vector<value*>)>>(f)); }
		value::value( const boost::function<value(std::vector<value*>)>& f ) { init(functor_object_adapter<boost::function<value(std::vector<value*>)>>(f)); }

		struct print_visitor {
			typedef value result_type;
			std::ostream* os;
			print_visitor( std::ostream& os ): os(&os) {}
			template < typename V > value operator()( V v ) const { *os << v; return value(); }
